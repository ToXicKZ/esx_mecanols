...
Config.Zones = {
  ...
  Garage = {
    Pos   = { x = -343.946, y = -131.36, z = 39.01 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -360.08, y = -128.69, z = 38.696 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -354.92, y = -115.73, z = 38.7 },
